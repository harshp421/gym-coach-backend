...
import { bodyMetricSchema, completeOnboardingSchema, updateProfileSchema, } from "../profile.schemas.js";
const router = Router();
router.use(requireAuth);
router.get("/profile", ctrl.getProfile);
router.put("/profile", validateBody(updateProfileSchema), ctrl.updateProfile);
router.post("/profile/complete-onboarding", validateBody(completeOnboardingSchema), ctrl.completeOnboarding);
