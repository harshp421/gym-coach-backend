...
import { completeSessionSchema, createSessionSchema, logSetSchema, } from "../sessions.schemas.js";
const router = Router();
...
router.post("/sessions", validateBody(createSessionSchema), ctrl.createSession);
router.get("/sessions/active", ctrl.getActiveSession);
router.get("/sessions/:id", ctrl.getSession);
router.patch("/sessions/:id/complete", validateBody(completeSessionSchema), ctrl.completeSession);
router.delete("/sessions/:id", ctrl.abandonSession);
router.post("/sessions/:id/sets", validateBody(logSetSchema), ctrl.logSet);
