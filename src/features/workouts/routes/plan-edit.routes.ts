...
router.post(
    "/plan/empty",
    validateBody(createEmptyPlanSchema),
    ctrl.createEmptyPlan,
)
...
router.post(
    "/plan/days/reorder",
    validateBody(reorderDaysSchema),
    ctrl.reorderDays,
)
...
router.post(
    "/plan/days/:dayId/exercises/reorder",
    validateBody(reorderExercisesSchema),
    ctrl.reorderExercises,
)
router.post(
